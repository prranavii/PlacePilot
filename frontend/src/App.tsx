...
const MainLayout: React.FC = () => {
  ...
  if (verifyStatus !== 'idle') {
    return (
      <div className="min-h-screen bg-obsidian bg-dot-grid-dark flex items-center justify-center p-4 relative overflow-hidden font-sans">
        ...
        <div className="w-full max-w-md bg-zinc-950/90 border border-white/5 rounded-3xl p-8 shadow-2xl backdrop-blur-xl relative z-10 text-center">
          ...
          {verifyStatus === 'loading' && (
            <div className="flex flex-col items-center py-6">
              <div className="animate-spin rounded-full h-8 w-8 border-2 border-crimson border-t-transparent mb-4" />
          ...
          {verifyStatus === 'success' && (
            <div className="space-y-6">
              <div className="bg-emerald-500/5 border border-emerald-500/15 text-emerald-400 text-xs rounded-xl p-3.5 flex items-start gap-2.5">
              ...
              <button
                ...
                className="w-full bg-crimson hover:bg-crimson/90 text-white font-bold text-xs py-3.5 rounded-xl shadow-lg shadow-crimson/15 hover:shadow-crimson/25 transition-all uppercase tracking-widest"
              >
                Sign In Now
              </button>
            </div>
          ...
          {verifyStatus === 'error' && (
            <div className="space-y-6">
              <div className="bg-crimson/5 border border-crimson/15 text-crimson text-xs rounded-xl p-3.5 flex items-start gap-2.5">
                <svg className="w-4.5 h-4.5 text-crimson shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
              ...
              <button
                onClick={() => setVerifyStatus('idle')}
                className="w-full bg-zinc-900 border border-white/5 text-zinc-400 hover:text-white font-bold text-xs py-3.5 rounded-xl transition-all uppercase tracking-widest"
              >
                Back to Home
              </button>
            </div>
  ...
  return (
    <div className="min-h-screen bg-obsidian bg-dot-grid-dark flex flex-col text-white transition-colors duration-200 relative overflow-hidden font-sans">
